  ...
  return (
    ...
    >
      <motion.div 
        ...
        className="relative w-full aspect-[4/3] rounded-2xl bg-zinc-950/80 backdrop-blur-xl border border-zinc-800/80 shadow-[0_0_100px_rgba(59,130,246,0.15)] overflow-hidden flex flex-col"
      >
        {/* Mockup Header */}
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="flex-1 p-6 relative bg-[#1e1e1e] font-mono text-[10px] leading-relaxed">
            ...
            <motion.div 
              ...
              className="absolute -left-8 top-1/3 bg-blue-950/80 backdrop-blur-md border border-blue-500/30 p-3 rounded-xl shadow-[0_0_30px_rgba(59,130,246,0.3)] flex flex-col items-center gap-2"
            >
            ...
            <motion.div 
              ...
              className="absolute -right-12 top-10 bg-emerald-950/80 backdrop-blur-md border border-emerald-500/30 px-4 py-2 rounded-full shadow-[0_0_30px_rgba(16,185,129,0.3)] flex items-center gap-2"
            >
            ...
            <motion.div 
              ...
              className="absolute left-1/4 -bottom-6 bg-purple-950/80 backdrop-blur-md border border-purple-500/30 px-4 py-2 rounded-full shadow-[0_0_30px_rgba(168,85,247,0.3)] flex items-center gap-2"
            >
          ...
          {/* Output Panel Right */}
          <div className="w-2/5 border-l border-zinc-800/80 bg-zinc-900/50 p-4 flex flex-col">
